...
let header_Header = class Header extends preact_min["Component"] {
	render() {
...
// CONCATENATED MODULE: ./routes/profile/index.js
		...
		/* harmony default export */ var profile = (async_default()(profile_load));
...
var _ref3 = Object(preact_min["h"])(profile, { path: '/profile/', user: 'me' });

var _ref4 = Object(preact_min["h"])(profile, { path: '/profile/:user' });

let app_App = class App extends preact_min["Component"] {
	constructor(...args) {
		var _temp;

		return _temp = super(...args), this.handleRoute = e => {
...
/******/ });
//# sourceMappingURL=bundle.909a6.js.map